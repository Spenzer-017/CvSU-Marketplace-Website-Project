...
price
image_path
seller_id (FOREIGN KEY) of user_id in users table
status
created_at
-----------------------------------------------------
messages table
...
msg_id (PRIMARY KEY)
sender_id (FOREIGN KEY) of user_id in users table
receiver_id (FOREIGN KEY) of user_id in users table
...
commment_id
commenter_id (FOREIGN KEY) of user_id in users table
item_id (FOREIGN KEY) of item_id in items table
comment
created_at
-----------------------------------------------------
...
cart_id (PRIMARY KEY)
user_id (FOREIGN KEY) of user_id in users table
item_id (FOREIGN KEY) of item_id in items table
quantity
-----------------------------------------------------
transactions
...
buyer_id (FOREIGN KEY) of user_id in users table
seller_id (FOREIGN KEY) of user_id in users table
item_id (FOREIGN KEY) of item_id in items table
status
created_at
