...
<div class="dashboard">
  ...
  <div class="dashboard-grid">
    ...
    <div>
      <div class="section-heading">
        <h2>My Listings</h2>
        <a href="/cvsu-marketplace/my-listings.php">View all ></a>
      </div>
            ...
            <?php foreach ($my_listings as $listing): ?>
              <tr>
                ...
                <td class="table-actions">
                  <a href="/cvsu-marketplace/edit-listing.php?id=<?= urlencode($listing['id']) ?>">Edit</a>
                  <a href="/cvsu-marketplace/delete-listing.php?id=<?= urlencode($listing['id']) ?>" class="delete">Delete</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
    ...
    <div>
      <div class="section-heading">
        <h2>Messages</h2>
        <a href="/cvsu-marketplace/messages.php">View all ></a>
      </div>
  ...
  <div class="section-heading">
    ...
    <a href="/cvsu-marketplace/purchases.php">View all ></a>
  </div>
