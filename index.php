...
<section class="hero">
  ...
  <?php if ($user): ?>
    <!-- Search bar -->
    <form class="hero-search" action="/cvsu-marketplace/browse.php" method="GET">
  ...
  <?php else: ?>
    <div class="hero-actions">
      <a href="/cvsu-marketplace/signup.php" class="btn-hero-primary">Create Free Account</a>
...
<div class="home-section-full">
  <div class="inner">
    <div class="section-heading">
      ...
      <a <?= ($user) ? 'href="/cvsu-marketplace/browse.php"' : 'href="/cvsu-marketplace/login.php"' ?>>View all ></a>
    </div>
    <div class="categories-grid">
      <?php foreach ($categories as $cat): ?>
        <a href="<?= ($user) ? '/cvsu-marketplace/browse.php?category=' . urlencode($cat['label']) : '/cvsu-marketplace/login.php' ?>" class="category-card">
...
<div class="home-section" id="featured-listings-part">
  <div class="section-heading">
    ...
    <a href="/cvsu-marketplace/browse.php">View all ></a>
  </div>
  <div class="listings-grid">
    <?php foreach ($featured as $item): ?>
      <a href="/cvsu-marketplace/listing.php?id=<?= urlencode($item['id']) ?>" class="listing-card">
  ...
  <div class="home-section" style="padding-top: 48px; padding-bottom: 48px;">
    <div class="cta-banner">
      ...
      <div class="cta-buttons">
        <a href="/cvsu-marketplace/signup.php" class="btn-cta-primary">Get Started</a>
